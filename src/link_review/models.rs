...
pub struct FileCard {
    ...
    /// When the link/file was generated by the bot (its `time` field), IST 24h.
...
impl FileCard {
    pub fn from_doc(doc: &Document, index: usize, fqdn: &str) -> Self {
        ...
        let reviewed_at = get_f64(doc, "reviewed_at")
            ...
            .unwrap_or_default();
        // The bot stores this as `time` (Unix seconds) when the file link is generated.
        let created_at = get_f64(doc, "time")
            .map(crate::util::format_ist)
